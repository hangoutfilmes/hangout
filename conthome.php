     ...
     <ul>
        ...
        <div id="conteudo"> 
            ...
            <div id="fundoverde">
                ...
                <div id="slides">
                    <ul>
                      <li><img src="img/panorama.jpg"></li>
                      <li><img src="img/natureza.jpg"></li>
                      <li><img src="img/sphere.jpg"></li>
                      <li><img src="img/plantation.jpg"></li>
                    </ul>
                </div>
                
              
                <div class="fundorosa">
         <div class="imagem_grande"> <a href="300.php"> <img src="img/145488.jpg"/>  </a>
                    
        </div>
                    
        <div id="texto_grande">
         <h3> TITULO </h3><br/><br/>
         <p> texto de exemplo para teste de exemplo blablablabla lalalalalalal para teste de
         lalalalalalal para teste de exemplopara teste de exemplolalalalalalal para teste de 
         lalalalalalal para teste de exemplopara teste de exempl
         lalalalalalal para teste de exemplopara teste de exempl
         lalalalalalal para teste de exemplopara teste de exempl
         lalalalalalal para teste de exemplopara teste de exempl
         lalalalalalal para teste de exemplopara teste de exempl
