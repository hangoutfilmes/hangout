     ...
     <ul>
        ...
        <div id="conteudo"> 
            ...
            <div id="fundoverde">
                ...
                <div class="fundorosa">
    <div class="imagem_grande"> <a href="conthome.php"> <img src="img/145488.jpg"/>  </a>
            <div id="descricao_img">
            </div>
    </div>
        ...
        <div id="texto_grande">
          <p> &nbsp TITULO<br/><br/>
            texto de exemplo para teste de exemplo blablablabla<br/>
            lalalalalalal para teste de exemplopara teste de exemplo
          </p>
        </div>
