     ...
     <ul>
        ...
        <div id="conteudo"> 
            ...
            <div id="fundoverde">
                ...
                <div class="fundorosa">
                    <div class="imagem_grande"> <a href=""> <img src="img/monstos_sa_grande.jpg"/>  </a>
                    
        </div>
                    
        <div id="texto_grande">
         <h3> Monstros S.A. </h3><br/><br/>
         <p>  Um olhar diferente sobre os monstros, um gênero infantil que agrada também os adultos. 
             A cidade Monstrópolis, onde a energia é tirada dos sustos das crianças. Cada um dos pequenos
             tem o seu monstro ideal conseguindo arrancar o maior número de gritos possíveis, 
             abastecendo a cidade com energia.</p>
         
            <p>A trama começa quando uma garotinha chamada de Boo de cerca de 2 a 3 anos, entra na fábrica
                arrancando muitos gritos dos próprios monstros que temem crianças. Acreditam que o toque 
                dos pequenos pode levar a morte instantânea. Então cabe a Sulley um bicho azul com grandes
                dentes resolver a confusão.</p>
            <p>Monstros S.A. tem o mesmo talento do famoso Shrek. Trata-se de um desenho de alta 
                tecnologia que muda os paradigmas de como vemos os monstros e personagens afins, que 
                fazem a gente se deliciar com a simpatia dos bichos-papões se iguala ao carisma do ogro.
            </p>
        </div>
