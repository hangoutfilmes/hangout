...
<div id='cssmenu'>
     <ul>
        ...
        <div id="texto_grande">
         <h3> Pedro e Bianca</h3><br/><br/>
         <p> </p>
         
            <p>A série conta a história de dois irmãos gêmeos, de 15 anos. Bianca é negra como seu pai, e Pedro branco 
                como sua mãe, estudam em um colégio público e moram em um bairro residencial fora do eixo central de SP,
                que é repleto de sobrados bem simples.. </p>
            <p>
                Já assisti alguns episódios da série e percebi que são leves interessantes e, acima de tudo, muito 
                próximos da realidade. Sem ter aquela particularidade de falar sobre um universo específico, o adolescente
                da classe C, e sem que existam clichês, e de um jeito que possa interessar a quaisquer públicos, de 
                indeterminada idade.
            </p>
            <p>Os produtores, atores e todos que participaram deste maravilhoso trabalho estão de parabéns, pois foi tudo
                feito com bastante clareza e organização de ambas as partes.
            </p>
