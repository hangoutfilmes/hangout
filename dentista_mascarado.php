     ...
     <ul>
        ...
        <div id="conteudo"> 
            ...
            <div id="fundoverde">
                ...
                <div class="fundorosa">
                    <div class="imagem_grande"> <a href=""> <img src="img/dentista_mascarado_grande.jpg"/>  </a>
                    
        </div>
                    
        <div id="texto_grande">
         <h3> O Dentista Mascarado</h3><br/><br/>
         <p> </p>
         
            <p>Foi uma das produções mais bem-sucedidas de Fernanda Young e Alexandre Machado, a série tratava do avesso
                o inesgotável poço desse grande tema. Foi impulsionada, em outro nível, por diálogos espirituosos. </p>
            <p>
                Nessa mais nova obra “O Dentista Mascarado” faltou o básico, que foi ter um humor rico e histórias mais 
                fortes que pudesse chamar a atenção do seu espectador.
            </p>
            <p>O enredo foi incapaz de arrancar sorrisos do espectador e com isso a infâmia das piadas se agravou muito.
            </p>
            <p>Foi dado como maior crítica que essa série não foi capaz de agradar seu publico, e o público do recreio 
                da sexta-série, por ser um pouco confusa de se entender, e as linguagens que só contêm piadas que não 
                agradou a todos que assistiram.</p>
