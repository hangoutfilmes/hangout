     ...
     <ul>
        ...
        <div id="conteudo"> 
            ...
            <div id="fundoverde">
                ...
                <div class="fundorosa">
                    <div class="imagem_grande"> <a href=""> <img src="img/aproveitar_fim_grande.jpg"/>  </a>
                    
        </div>
                    
        <div id="texto_grande">
         <h3> Como Aproveitar o Fim do Mundo </h3><br/><br/>
         <p> </p>
         
            <p>Com o texto afiado e esperto, a produção narra a historia de dois colegas de trabalho que resolve pôr fim a 
                todas as pendências de suas vidas antes que a vida no planeta acabe, e como prevê o calendário Maia. Foi usa
                da uma idéia bem simples, que, em si, não precisam guardar nenhuma específica genuidade. Só teria que fazer 
                rir e promover situações interessantes e que prendesse a atenção de seus espectadores. </p>
            <p>Algumas cenas nunca saem como planejadas, mas destacou de maneira simples e unânime o talento da atriz Alinne
                Moraes, ela tem timing para fazer comédia e o texto dos autores lhe caíram como uma luva. Porém a combinação
                não funcionou muito bem, pelo fato de subverter a imagem da artista construída por meio das novelas que já 
                atuara.
            </p>
            <p>De acordo com uma prévia do ibope, essa série registrou 16 pontos de média, que significa um número 
                considerado bom para uma estréia que caiu na véspera de um feriado.
            </p>
