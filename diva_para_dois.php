     ...
     <ul>
        ...
        <div id="conteudo"> 
            ...
            <div id="fundoverde">
                ...
                <div class="fundorosa">
                    <div class="imagem_grande"> <a href=""> <img src="img/um_diva_grande.jpg"/>  </a>
                    
        </div>
                    
        <div id="texto_grande">
         <h3> Um Divã para Dois </h3><br/><br/>
         <p> </p>
         
            <p>O material dessa série sugeriu uma comédia maliciosa, focada no erotismo e nas perversões sexuais. </p>
            <p>
                Trata-se de um romance dramático sobre a terceira idade, dotado em um ritmo particularmente lento, 
                arrastado, linear. O humor é discreto, nada apelativo.
            </p>
            <p>O filme é surpreendentemente em vários sentidos, o tom termo, gentil e inofensivo é uma surpresa em uma
                história que aborda tão francamente o sexo. Porém o fator inesperado é mesmo o ritmo, a história é 
                lentíssima e voluntariamente repetitiva, adotando um estilo “indie”, nas músicas onipresentes, na luz 
                bege e sem contraste, nos cenários de interiores felpudos e acolhedores, porém esquecendo que a produção 
                dispõe de grandes estrelas e de um caro orçamento.
            </p>
            <p>O filme traz uma melancolia duramente realista, e feita isso se perdoa a trilha sonora excessiva, a placidez
                quase entediante do conjunto.</p>
